...
public class DateUtils {
    ...
    public static Integer getMonthsDifference(String startDate, String endDate) {
        LocalDate fromLd = LocalDate.of(Integer.parseInt(startDate.substring(0, 4)), Integer.parseInt(startDate.substring(4, 6)),
                Integer.parseInt(startDate.substring(6, 8)));
        LocalDate toLd = LocalDate.of(Integer.parseInt(endDate.substring(0, 4)), Integer.parseInt(endDate.substring(4, 6)),
    ...
    public static Integer getQuarter(String dateStr) {
        LocalDate ld = LocalDate.of(Integer.parseInt(dateStr.substring(0, 4)), Integer.parseInt(dateStr.substring(4, 6)),
    ...
    public static String plus(String dateStr, String format, Integer plusDays, String dateUnit) {
        ...
        case "WEEK":
            return localDate.plusWeeks(plusDays).format(DateTimeFormatter.ofPattern(format));
        case "MONTH":
            return localDate.plusMonths(plusDays).format(DateTimeFormatter.ofPattern(format));
        case "YEAR":
            return localDate.plusYears(plusDays).format(DateTimeFormatter.ofPattern(format));
        default:
